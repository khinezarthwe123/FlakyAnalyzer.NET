...
{
    [TestFixture]
    public class ChromeUIBehaviorTest : CsvLogger
    {
        ...
        public void Setup()
        {
            ...
            browserVersion = ((ChromeDriver)driver).Capabilities.GetCapability("browserVersion")?.ToString() ?? string.Empty;
            browserName = ((ChromeDriver)driver).Capabilities.GetCapability("browserName")?.ToString() ?? string.Empty;
        }
