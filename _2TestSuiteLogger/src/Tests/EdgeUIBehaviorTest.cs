...
{
    [TestFixture]
    public class EdgeUIBehaviorTest : CsvLogger
    {
        ...
        public void Setup()
        {
            ...
            browserVersion = ((EdgeDriver)driver).Capabilities.GetCapability("browserVersion")?.ToString() ?? string.Empty;
            browserName = ((EdgeDriver)driver).Capabilities.GetCapability("browserName")?.ToString() ?? string.Empty;
        }
